...
package com.upc.talkia_proyect.config;

import com.upc.talkia_proyect.filters.JwtRequestFilter;
import com.upc.talkia_proyect.services.CustomUserDetailsService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/authenticate","/api/user").permitAll()
